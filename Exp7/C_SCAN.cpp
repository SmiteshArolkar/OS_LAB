...
int calculateTotalSeekTimeCSCAN(const vector<int>& requestOrder, int initialPosition) {
    int totalSeekTime = 0;
...
int main() {
    ...
    // Calculate and display total seek time for C-SCAN
    int totalSeekTimeCSCAN = calculateTotalSeekTimeCSCAN(requestOrder, initialPosition);
    cout << "Total Seek Time using C-SCAN: " << totalSeekTimeCSCAN << endl;
